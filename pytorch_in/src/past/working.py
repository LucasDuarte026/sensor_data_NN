...
# Extract the input and output variables as PyTorch tensors
...
plt.plot(data.voltage, data.velocity, color='r', label='data')
plt.plot(data.voltage, predictions.detach().numpy(),
